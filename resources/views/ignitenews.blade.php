        ...
        <div id="main-animated-bg-root"></div>
            ...
            <div class="container mx-auto px-4 py-12">
                <div class="max-w-4xl mx-auto bg-[#0F2A55]/50 backdrop-blur-sm border border-[#69B3E3]/20 rounded-lg p-8">
                    <!-- Article Header -->
                    <div class="mb-8">
                        <h1 class="text-4xl font-bold text-[#FEE66C] mb-4 font-['Rajdhani']">New Team has arrived: VIOR Ignite</h1>
                        <div class="text-[#CBCBCB] mb-4">Published: February 17, 2025</div>
                        <div class="w-full h-[2px] bg-gradient-to-r from-[#69B3E3]/40 to-transparent"></div>
                    </div>

                    <!-- Article Image -->
                    <div class="mb-8">
                        <img src="{{ asset('images/news2.png') }}" alt="new vior ignite" class="w-full h-auto rounded-lg shadow-lg">
                    </div>

                    <!-- Article Content -->
                    <div class="prose prose-invert max-w-none">
                        <p class="text-lg text-[#FCFEFD] leading-relaxed mb-6">
                            Meet Ignite, the fresh faces of VIOR's Valorant Division! This team is unique, with players ranging from Platinum to Iron, creating a dynamic learning environment. Under the guidance of Head Coach Rho and Assistant Coach HaruMiz, Ignite is rapidly developing. Rho and HaruMiz each bring unique strengths to the coaching dynamic, helping bridge the rank gap within the team. Despite their varying experience levels, Ignite has a powerful motivation to learn and grow together, and they're determined to make their mark on the VTuber Valorant scene!
                        </p>

                        <p class="text-lg text-[#FCFEFD] leading-relaxed mb-6">
                            Ignite's progress has been remarkable, especially after recent scrimmages with VIOR's established teams, Eclipse and Reverie. While they initially faced a defeat against the more experienced Eclipse squad, Ignite quickly rebounded with a strong performance against Reverie. This showed all of us at VIOR that learning from mistakes is the key to improvement. Tetsuya, one of Ignite's Duelists, shared that they learned invaluable lessons from these scrims with their upper-ranked teammates.
                        </p>

                        <div class="my-8 p-4 bg-[#69B3E3]/10 border-l-4 border-[#69B3E3] rounded">
                            <p class="text-[#FCFEFD] italic">
                                "If you're thinking about joining VIOR, whether as a student or a player, be prepared to be challenged and pushed beyond your comfort zone by our coaches! They have high expectations and a structured approach to improvement."
                                <span class="block mt-2 text-sm">- Tetsuya, VIOR Ignite Duelist</span>
                            </p>
                        </div>

                        <p class="text-lg text-[#FCFEFD] leading-relaxed mb-6">
                            Coach Rho emphasizes the team's incredible passion, noting that he sometimes struggles to keep up with their energy as they relentlessly pursue improvement in both individual skills and team strategies. While acknowledging they have a long journey ahead, the team has already set ambitious goals, including competing and winning in Tier 3 tournaments. With their dedication to improving team communication and strategic coordination, Ignite is poised to become a formidable force in the VTuber Valorant scene.
                        </p>
                    </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-[#69B3E3]/20">
                        <div class="flex items-center space-x-4">
                            ...
                            <span class="text-[#FCFEFD]">Nathan Lunardi</span>
                        </div>
                    </div>
                </div>
            </div>

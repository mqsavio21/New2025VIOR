    ...
    <div id="page-content" class="min-h-screen transition-transform duration-300 ease-in-out">
        ...
        <div class="pt-24 relative overflow-hidden min-h-screen">            
            ...
            <div class="relative h-[500px] mb-12">
                ...
                <div class="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-transparent via-[#FEE66C] to-transparent shadow-[0_0_10px_rgba(254,230,108,0.7)] z-10"></div>

                <!-- Left Yellow Line Shadow -->
                <div class="absolute top-0 bottom-0 left-0 w-[3px] bg-gradient-to-b from-transparent via-[#FEE66C] to-transparent shadow-[0_0_10px_rgba(254,230,108,0.7)] z-10"></div>

                <!-- Right Yellow Line Shadow -->
                <div class="absolute top-0 bottom-0 right-0 w-[3px] bg-gradient-to-b from-transparent via-[#FEE66C] to-transparent shadow-[0_0_10px_rgba(254,230,108,0.7)] z-10"></div>
                ...
                <div class="relative h-full flex flex-col items-center justify-center text-center px-2">
                    <img src="{{ asset('images/logo.png') }}" alt="VIOR Tower Logo" class="h-32 md:h-48 mb-4">
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 font-['Orbitron']">VIOR Academy</h1>
                </div>

                <!-- Bottom Yellow Line Shadow -->
                <div class="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-transparent via-[#FEE66C] to-transparent shadow-[0_0_10px_rgba(254,230,108,0.7)] z-10"></div>
            </div>
